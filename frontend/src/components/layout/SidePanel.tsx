...
import { BookOpen, LineChart, ListOrdered, Sparkles, Upload } from 'lucide-react';
import { useUIStore, type SidePanelTabId } from '../../store/uiStore';
...
type TabId = SidePanelTabId;

export function SidePanel({ analysis, moves, explore, review, importPanel }: SidePanelProps) {
  ...
  const tabs: TabItem[] = useMemo(
    () => [
      ...
      { id: 'explore', label: 'Explore', icon: <BookOpen size={14} /> },
