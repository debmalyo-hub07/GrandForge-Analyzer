...
- Models in `backend/models/`, Zod request schemas in `backend/zodSchemas.ts`. Cached evals are stored **White-relative** (Position model convention) — the review service flips to/from mover-relative at the boundary.
